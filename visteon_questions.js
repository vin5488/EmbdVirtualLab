        ...
        "testCases": [
            {
                "name": "Sample 1",
                "stdin": "130 98 3",
                "expectedOutput": "Warning: Overspeed\nHigh Temperature\nThird Gear"
            }
        ]
    },
    {
        ...
        "testCases": [
            {
                "name": "Moving Open",
                "stdin": "1 20",
                "expectedOutput": "ALARM: Door Open!"
            }
        ]
    },
    {
        ...
        "testCases": [
            {
                "name": "Skid",
                "stdin": "30 5",
                "expectedOutput": "ESC Intervention"
            }
        ]
    },
    {
        ...
        "testCases": [
            {
                "name": "Critical",
                "stdin": "8",
                "expectedOutput": "CRITICAL: Fuel Empty - Stop Now!"
            },
            {
                "name": "Low",
                "stdin": "20",
                "expectedOutput": "Warning: Low Fuel"
            },
            {
                "name": "Half",
                "stdin": "40",
                "expectedOutput": "Fuel Below Half"
            },
            {
                "name": "OK",
                "stdin": "80",
                "expectedOutput": "Fuel OK"
            }
        ]
    },
    {
        ...
        "testCases": [
            {
                "name": "Redline",
                "stdin": "7500",
                "expectedOutput": "DANGER: Redline! Ease Off!"
            },
            {
                "name": "High",
                "stdin": "6000",
                "expectedOutput": "Warning: High RPM"
            },
            {
                "name": "Normal",
                "stdin": "4000",
                "expectedOutput": "RPM Normal"
            },
            {
                "name": "Low",
                "stdin": "1500",
                "expectedOutput": "Low RPM - Acceleration Needed"
            }
        ]
    },
    {
        ...
        "testCases": [
            {
                "name": "Critical",
                "stdin": "10",
                "expectedOutput": "CRITICAL: Oil Pressure Low - Engine Shutdown!"
            },
            {
                "name": "Low Warn",
                "stdin": "22",
                "expectedOutput": "Warning: Oil Pressure Low"
            },
            {
                "name": "Normal",
                "stdin": "55",
                "expectedOutput": "Oil Pressure Normal"
            },
            {
                "name": "High",
                "stdin": "90",
                "expectedOutput": "Warning: Oil Pressure High"
            }
        ]
    },
    {
        ...
        "testCases": [
            {
                "name": "OFF",
                "stdin": "0",
                "expectedOutput": "Engine OFF"
            },
            {
                "name": "ACC",
                "stdin": "1",
                "expectedOutput": "Accessories ON"
            },
            {
                "name": "ON",
                "stdin": "2",
                "expectedOutput": "Engine ON - Ready"
            },
            {
                "name": "Start",
                "stdin": "3",
            ...
            },
            {
                "name": "Invalid",
                "stdin": "5",
                "expectedOutput": "Invalid Key Position"
            }
        ]
    },
    {
        ...
        "testCases": [
            {
                "name": "Very Hot",
                "stdin": "30 22",
                "expectedOutput": "A/C Cooling: Fan High"
            },
            {
                "name": "Slightly Hot",
                "stdin": "24 22",
                "expectedOutput": "A/C Cooling: Fan Low"
            },
            {
                "name": "Very Cold",
                "stdin": "15 22",
                "expectedOutput": "Heater: Fan High"
            },
            {
                "name": "Slightly Cold",
                "stdin": "20 22",
                "expectedOutput": "Heater: Fan Low"
            },
            {
                "name": "OK",
                "stdin": "22 22",
                "expectedOutput": "Temperature OK - Fan Off"
            }
        ]
    },
    {
        ...
        "testCases": [
            {
                "name": "Critical",
                "stdin": "3",
                "expectedOutput": "CRITICAL: Brake Failure! Stop Vehicle!"
            },
            {
                "name": "Low",
                "stdin": "7",
                "expectedOutput": "Warning: Brake Pressure Low"
            },
            {
                "name": "Normal",
                "stdin": "15",
                "expectedOutput": "Brake Pressure Normal"
            },
            {
                "name": "Excessive",
                "stdin": "25",
                "expectedOutput": "Warning: Brake Pressure Excessive"
            }
        ]
    },
    {
        ...
        "testCases": [
            {
                "name": "Idle",
                "stdin": "0",
                "expectedOutput": "Engine Idle"
            },
            {
                "name": "Economy",
                "stdin": "15",
                "expectedOutput": "Economy Mode"
            },
            {
                "name": "Normal",
                "stdin": "45",
                "expectedOutput": "Normal Drive Mode"
            },
            {
                "name": "Sport",
                "stdin": "75",
                "expectedOutput": "Sport Mode"
            },
            {
                "name": "Full",
                "stdin": "95",
                "expectedOutput": "FULL THROTTLE"
            }
        ]
    },
    {
        ...
        "testCases": [
            {
                "name": "Heavy Rain",
                "stdin": "80 1",
                "expectedOutput": "Wiper: Fast"
            },
            {
                "name": "Medium Rain",
                "stdin": "50 1",
                "expectedOutput": "Wiper: Medium"
            },
            {
                "name": "Light Rain",
                "stdin": "20 1",
                "expectedOutput": "Wiper: Slow"
            },
            {
                "name": "No Rain",
                "stdin": "5 1",
                "expectedOutput": "Wiper: Off"
            },
            {
                "name": "Switch Off",
                "stdin": "90 0",
        ...
        "testCases": [
            {
                "name": "Critical",
                "stdin": "125",
                "expectedOutput": "CRITICAL OVERHEAT - Shutdown Now!"
            },
            {
                "name": "High",
                "stdin": "105",
                "expectedOutput": "High Temp - Fan Max Speed"
            },
            {
                "name": "Warm",
                "stdin": "90",
                "expectedOutput": "Warm - Fan Medium Speed"
            },
            {
                "name": "Normal",
                "stdin": "70",
                "expectedOutput": "Normal - Fan Low Speed"
            },
            {
                "name": "Cold",
                "stdin": "40",
                "expectedOutput": "Engine Cold - Fan Off"
            }
        ]
    },
    {
        ...
        "testCases": [
            {
                ...
                "stdin": "35 1",
                "expectedOutput": "AIRBAG DEPLOYED"
            },
            {
                "name": "Unbelted Crash",
                "stdin": "25 0",
            ...
            },
            {
                "name": "Severe Belted",
                "stdin": "25 1",
                "expectedOutput": "Severe Impact - Monitoring"
            },
            {
                "name": "Minor Impact",
                "stdin": "15 1",
                "expectedOutput": "Minor Impact - Alert"
            },
            {
                "name": "Normal",
                "stdin": "5 1",
                "expectedOutput": "System Normal"
            }
        ]
    }
];
