...
window.VISTEON_PROJECTS = [
    {
        ...
        acceptance: ['Correct use of bitwise OR/AND/XOR', 'Hexadecimal parsing and printing', 'Static memory duration implemented'],
        deliverables: ['main.c'],
        ...
        testCases: [{ name: 'Basic Sets', stdin: 'SET_BIT 0\nSET_BIT 1', expectedOutput: '0x01\n0x03' }]
    },
    {
        id: 'VISTEON-02',
        topicId: 'VISTEON_C',
        ...
        acceptance: ['Pointer arithmetic only for traversal', 'Correct swapping logic', 'No array index brackets allowed inside processor function'],
        deliverables: ['main.c'],
        ...
        testCases: [{ name: 'Short Array', stdin: '4\n1 9 4 5', expectedOutput: '9 4 1 5' }]
    },
    {
        id: 'VISTEON-03',
        topicId: 'VISTEON_C',
        ...
        acceptance: ['Memory packing achieved correctly', 'Union based serialization applied', 'Endienness awareness demonstrated (assume Little Endian)'],
        deliverables: ['main.c'],
        ...
        testCases: [{ name: 'Dummy Input', stdin: '01 00 02 00 00 80 3F', expectedOutput: 'ID: 1, Status: 2, Payload: 1.000000' }]
    },
    {
        id: 'VISTEON-04',
        topicId: 'VISTEON_C',
        ...
        acceptance: ['Array of function pointers used', 'No switch-case for state routing', 'State encapsulation respected'],
        deliverables: ['main.c'],
        ...
        testCases: [{ name: 'Engine Start Sequence', stdin: '1 2 -1', expectedOutput: 'Entered INIT\nEntered ACCESSORY\nEntered RUN' }]
    },
    {
        id: 'VISTEON-05',
        topicId: 'VISTEON_C',
        ...
        acceptance: ['Bit-fields cleanly defined without overflow', 'Union mapping to uint32_t', 'Mask correctly applied'],
        deliverables: ['main.c'],
        ...
        testCases: [{ name: 'Mask Disable', stdin: '3 15 1 1000 0xFFFFFFFC', expectedOutput: '0x00003E0C' }]
    }
];
